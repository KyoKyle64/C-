...
int main()
{
 ...
 cout << "Starting balance    :   $ " << setw(9) << startBalance << endl;
 cout << "Total deposits      : + $ " << setw(9) << totalDeposits << endl;
 cout << "Total withdrawals:  : - $ " << setw(9) << totalWithdrawls << endl;
 cout << "Total interest:     :   $ " << setw(9) << totalIntrest << endl;
 cout << "                     --------------"<< setw(9) << endl;
 cout << "Ending balance:      :  $ " << setw(9) << totalBalance << endl;
